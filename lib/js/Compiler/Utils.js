...
exports.substitute = (t, sigma) => {
    var _a;
    if (isVar(t))
        return (_a = Types_1.mapGet(sigma, t)) !== null && _a !== void 0 ? _a : t;
    return { name: t.name, args: t.args.map(s => exports.substitute(s, sigma)) };
};
exports.termsEq = (a, b) => {
    if (isVar(a) && isVar(b))
        return a === b;
    if (isFun(a) && isFun(b)) {
        return a.name === b.name &&
            ...
            Utils_1.every(zip(a.args, b.args), ([s, t]) => exports.termsEq(s, t));
    }
    return false;
};
...
exports.isRuleRecursive = ([lhs, rhs]) => {
    ...
    return Utils_1.some(Utils_1.traverseNames(rhs), f => f === name);
};
...
exports.alphaEquiv = (s, t) => (isSomething(alphaEquivAux([hasDuplicates(vars(t)) ? [t, s] : [s, t]])));
const alphaEquivAux = (eqs, sigma = {}) => {
    if (isEmpty(eqs))
        return sigma;
    const [a, b] = eqs.pop();
    if (isVar(a) && isVar(b)) {
        if (Types_1.mapHas(sigma, a)) {
            ...
            return alphaEquivAux(eqs, Types_1.mapSet(sigma, a, b));
        }
    }
